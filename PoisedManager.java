...
public class PoisedManager {
	...
	*/
	...
	public static void main(String[] args) {
		...
		*/
		try (BufferedReader ProjectReader = new BufferedReader(new FileReader("CompletedProject.txt"))) {
		...
		while (true) {
			...
			*/
			...
			if (userChoice.equals("1")) {
				...
				*/
				System.out.println("Enter due date for example 12 July 2022: ");
				...
				*/
				System.out.println("Enter Architect first name:");
				...
				*/
				...
				System.out.println("Enter Contractor's surname:");
				...
				*/
				...
				/**
				* Asking customer which project they want to change deadline
				*/
				int deadlineIndex = 0;
				while (true) {
					try {
				...
				*/
				System.out.println("Enter new project deadline date for example 15 July 2022:");
				...
				*/
				...
				while(true) {
					try {
						...
						input.nextLine();
						finalisedIndex = finalisedIndex - 1;
						break;
					}
					catch(Exception e) {
						System.out.println("Please enter correct format");
				...
				*/
				...
				Difference = ProjectArray.get(finalisedIndex).totalFee - ProjectArray.get(finalisedIndex).amountPaid;
				...
				if (Difference == 0) {
					...
					*/
					...
					ProjectArray.get(finalisedIndex).setProjectCompleted("Yes");
					ProjectArray.get(finalisedIndex).setDateCompleted(currentDate);
				}else {
					System.out.println("Invoice generated");
					System.out.println(ProjectArray.get(finalisedIndex).Customer.toString());
			...
			try {
				for (int i = 0; i < ProjectArray.size(); i++) {
					...
					FileWriter myWriter = new FileWriter(
							...
							+ ProjectArray.get(i).erfNumber + "#" + ProjectArray.get(i).totalFee + "#"
							+ ProjectArray.get(i).amountPaid + "#" + ProjectArray.get(i).deadline + "#"
							+ ProjectArray.get(i).projectCompleted + "#" + ProjectArray.get(i).dateCompleted + "#"
